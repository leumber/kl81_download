...
#define LOG_TAG "LIBUSB"  //过滤信息

#define ALOGE(format,...)		 __android_log_print(ANDROID_LOG_ERROR, LOG_TAG, "[%s][%d] "format"",__FUNCTION__,__LINE__,##__VA_ARGS__)
